...
exports.defaultStreamCppPayload = exports.defaultStreamCppCurrentFile = exports.defaultRefreshTabContextPayload = void 0;
exports.defaultRefreshTabContextPayload = {
    currentFile: {
...
exports.defaultStreamCppCurrentFile = {
...
exports.defaultStreamCppPayload = {
    isDebug: false,
    giveDebugOutput: false,
    supportsCpt: false,
    supportsCrlfCpt: false,
    currentFile: exports.defaultStreamCppCurrentFile,
    diffHistory: [],
    modelName: "fast",
    diffHistoryKeys: [],
    fileDiffHistories: [
